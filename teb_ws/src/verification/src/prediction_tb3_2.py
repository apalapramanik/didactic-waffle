...
class predict:
    def __init__(self):
        ...
        #subscribers
        rospy.Subscriber("tb3_2/projected",pc2,self.cloud_callback_tb3_2,queue_size=10)  
        rospy.Subscriber("tb3_2/cp_flag", String, self.cp_flag_callback_tb3_2, queue_size=10 )
        rospy.Subscriber("tb3_2/odom", Odometry, self.odom_callback_tb3_2,queue_size=10)
        
        #publishers
        self.pose_human1 = rospy.Publisher("tb3_2/position_h1", position,queue_size=10)
        self.pose_human2 = rospy.Publisher("tb3_2/position_h2", position,queue_size=10)
        self.pred1_array = rospy.Publisher("tb3_2/pred1_array",Float32MultiArray,queue_size=10)
        self.pred2_array = rospy.Publisher("tb3_2/pred2_array",Float32MultiArray,queue_size=10)
        
        self.flag = "no"
        
    def cp_flag_callback_tb3_2(self, msg):
        self.flag = msg.data
        
   
    def odom_callback_tb3_2(self, data):
    ...
    def cloud_callback_tb3_2(self, data):
