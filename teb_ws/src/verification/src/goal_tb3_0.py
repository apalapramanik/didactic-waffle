...
class TurnRobotNode:
    def __init__(self):
        ...
        print("init node")
        rospy.init_node('turn_robot_node_tb3_0')
        self.move_base_client = actionlib.SimpleActionClient('/tb3_0/move_base', MoveBaseAction) 
        ...
        rospy.Subscriber("/tb3_0/move_base/feedback",MoveBaseActionFeedback,self.feed_cb,queue_size=10)
    ...
    def turn_robot(self, angle_degrees):
        ...
        turn_goal.target_pose.header.frame_id = 'tb3_0_tf/base_link'
...
if __name__ == '__main__':
    try:
        ...
        """
        #case 2:
        # orientation = [-0.003284, -0.003284, 2.642751]
        # position = {'x':18.376935, 'y' :-1.841782} 
        # quaternion = {'r1' :-0.000, 'r2' : -0.000, 'r3' : 0.960, 'r4' : 0.281} #run command : rosrun tf tf_echo /map /base_link
       
        
        #case 1:
        orientation = [-0.003284, -0.003284, 2.642751]
        position = {'x': 7.972651, 'y' :0.070677} 
        quaternion = {'r1' :-0.000, 'r2' : -0.000, 'r3' : 0.960, 'r4' : 0.281} #run command : rosrun tf tf_echo /map /base_link
