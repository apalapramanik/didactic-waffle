...
class ObjectDetectionNode:
    def __init__(self):
        ...
        # Publishers  tb3_0
        self.annotated_image_pub = rospy.Publisher('tb3_0/annotated_image', Image, queue_size=10)
        self.yolo_info_pub = rospy.Publisher('tb3_0/yolo_depth_topic', yolodepth, queue_size=10)
        self.cloud_processing_pub = rospy.Publisher('tb3_0/cp_flag', String, queue_size=10)
        
         # Publishers tb3_1
        self.annotated_image_pub = rospy.Publisher('tb3_1/annotated_image', Image, queue_size=10)
        self.yolo_info_pub = rospy.Publisher('tb3_1/yolo_depth_topic', yolodepth, queue_size=10)
        self.cloud_processing_pub = rospy.Publisher('tb3_1/cp_flag', String, queue_size=10)
        
         # Publishers tb3_2
        self.annotated_image_pub = rospy.Publisher('tb3_2/annotated_image', Image, queue_size=10)
        self.yolo_info_pub = rospy.Publisher('tb3_2/yolo_depth_topic', yolodepth, queue_size=10)
        self.cloud_processing_pub = rospy.Publisher('tb3_2/cp_flag', String, queue_size=10)
