...
class ObjectDetectionNode:
    ...
    #         cv2.rectangle(depth_image, (int(x1), int(y1)), (int(x2), int(y2)), (252, 119, 30), 2)

    #         # Draw the bounding box
    #         cv2.putText(depth_image, label, (int(x1), int(y1)-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (252, 119, 30), 2)
